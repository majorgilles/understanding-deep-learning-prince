...
- **Book pages:** 269-275
- **Chapter PDF:** [`chapter-14-unsupervised-learning.pdf`](chapter-14-unsupervised-learning.pdf)
...
- **GitHub issue:** [#14](https://github.com/majorgilles/understanding-deep-learning-prince/issues/14)

## Focus

Survey unsupervised and generative model families and the challenge of evaluating generated samples.

## Learning checkpoint

Compare generative model families and define useful dimensions of generative-model performance.

## Notebooks

| Notebook | Source | Status |
|---|---|---|
| [`14_1_Unsupervised_Learning_Study_Guide.ipynb`](notebooks/14_1_Unsupervised_Learning_Study_Guide.ipynb) | This repository | Original study guide (MIT) |
