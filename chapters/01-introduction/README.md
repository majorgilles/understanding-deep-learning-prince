...
- **Book pages:** 1-16
- **Chapter PDF:** [`chapter-01-introduction.pdf`](chapter-01-introduction.pdf)
...
- **GitHub issue:** [#1](https://github.com/majorgilles/understanding-deep-learning-prince/issues/1)

## Focus

Orient yourself to supervised, unsupervised, and reinforcement learning and the ethical context of deep learning.
...
|---|---|---|
| [`1_1_BackgroundMathematics.ipynb`](notebooks/1_1_BackgroundMathematics.ipynb) | [upstream](https://github.com/udlbook/udlbook/blob/main/Notebooks/Chap01/1_1_BackgroundMathematics.ipynb) | Official (MIT) |
